...
<body>
    ...
    <div class="fanhui padding"><a href="<?php echo U('index/index');?>"><span class="iconfont tb_fanhui"id="shangjia_info_fanhui">&#xe603;</span></a><?php echo ($p_cat_name); ?></div>
<div class="box">
    ...
    <li id='shaixuan_li'><div id="shaixuan">筛选<span class="iconfont tb_jiantou_xia" >&#xe602;</span></div><a href="<?php echo U('Category/index',$get_cs['fengge_1']);?>" class="iconfont tb_xianshi" id='fengge'>&#xe630;</a></li>
        </ul>
        
    </div>
    <div class="fenlei_select none" id="fenlei_select">
        <ul>
             <li id="<?php echo ($pid); ?>"><a href="<?php echo U('Category/index',array('cid'=>$pid));?>"><?php echo ($p_cat_name); ?><span class="count"><?php echo ($arr_count_cat["$pid"]); ?></span></a></li>
            <?php if(is_array($cat_all)): $i = 0; $__LIST__ = $cat_all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="<?php echo ($vo['cat_id']); ?>"><a href="<?php echo U('Category/index',array('cid'=>$vo['cat_id']));?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo['cat_name']); ?><span class="count"><?php echo ($arr_count_cat[$vo['cat_id']]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
                ...
                <a  href="<?php echo U('Goods/index',array('goods_id'=>$vo['goods_id']));?>" class="goods_a">
                    ...
                    <div class="goods_bottom">
                        <div class="goods_infor_left">
                            ...
                            <span class="price_red price"><span class='rmb'>&yen;</span><?php echo (floatval($vo['tuan_price'])); ?></span>
                            <span class="price_red yuan">元</span>
                            <del style="margin-left: 5px;">单买价:<?php echo (floatval($vo['price'])); ?>元</del>
                        </div>
...
<script> 
    ...
    var fengge0_url="<?php echo U('Category/index',$get_cs['fengge_0']);?>";
    var fengge1_url="<?php echo U('Category/index',$get_cs['fengge_1']);?>";
</script>
...
//选中的分类 背景更暗
$('#fenlei_select>ul>#<?php echo ($cat_id); ?>').css('background-color','#f6f4f0');
