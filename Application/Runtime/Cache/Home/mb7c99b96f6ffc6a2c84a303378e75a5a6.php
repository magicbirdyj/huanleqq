...
<body>
    ...
    <div class="view">
        <div class="d2">
            ...
            <?php if($wuliu['fangshi'] == '2'): ?><div class="d2_content"><span style="font-weight: bold">物流公司：<?php echo ($wuliu['company']); ?></span> <span>运单编号：<?php echo ($wuliu['no']); ?> </span></div>
            <?php elseif($wuliu['fangshi'] == '1'): ?>
                <div class="d2_content"><span style="font-weight: bold">骑手姓名：<?php echo ($wuliu['qishou_name']); ?></span> <span>骑手电话：<?php echo ($wuliu['qishou_mobile']); ?> </span></div><?php endif; ?>
        </div>

        <div class="d2_title">订单跟踪</div>
        <div class="d2_content">
            <ul class="wuliu_guiji_ul">
                 <?php if($wuliu['fangshi'] == '2'): if(is_array($wuliu_guiji)): $i = 0; $__LIST__ = $wuliu_guiji;if( count($__LIST__)==0 ) : echo "没有找到该物流的信息" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <div class="dian"></div>
                    <div class='guiji'>
