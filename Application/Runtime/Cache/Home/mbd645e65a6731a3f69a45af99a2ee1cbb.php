...
<body>
    <div class="fanhui padding"><a href="<?php echo U('Member/index');?>"><span class="iconfont tb_fanhui"id="shangjia_info_fanhui">&#xe603;</span></a>店铺订单</div>
    <div class="dingdan">
        <div class='dingdan_4'>
            <ul>
                <li>
                    <a href="<?php echo U('Shop/order');?>">
                ...
                <li>
                    <a href="<?php echo U('Shop/order?status=no_pay');?>">
                    <div class='dingdan_fenkai_tb_div'>
                ...
                <li>
                    <a href="<?php echo U('Shop/order?status=daifahuo');?>">
                    <div class='dingdan_fenkai_tb_div'>
                        <span class="iconfont tb_dingdan_li" style='font-size: 28px;'>&#xe62a;</span>
                ...
                <li>
                    <a href="<?php echo U('Shop/order?status=daishouhuo');?>">
                    <div class='dingdan_fenkai_tb_div'>
                        <span class="iconfont tb_dingdan_li">&#xe627;</span>
                ...
                <li>
                    <a href="<?php echo U('Shop/order?status=daipingjia');?>">
                    <div class='dingdan_fenkai_tb_div'>
                        <span class="iconfont tb_dingdan_li">&#xe629;</span>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a  href="<?php echo U('Shop/view_order',array('order_id'=>$vo['order_id']));?>"><!--内容遍历-->
                <div class="order_row">
                <div class='td_l'>
                ...
                <div class="td_r">
                    ...
                    <?php else: ?>
                        <div class="info_name shenglue"> 订单状态：<?php echo order_status_shops($vo['pay_status'],$vo['status'],$vo['order_id'])['status'];?></div><?php endif; ?>
                    <div class='info_name'><span>价格：&yen;<?php echo ($vo['price']); ?></span><span style="margin-left: 20px;">应付：&yen;<?php echo ($vo['dues']); ?></span></div>
                </div>
                </div>
            </a>
            <div class='action'>
                    <a  href="<?php echo order_status_shops($vo['pay_status'],$vo['status'],$vo['order_id'])['status_url'];?>" class="button_a_order"><?php echo order_status_shops($vo['pay_status'],$vo['status'],$vo['order_id'])['status_button'];?></a>
                    <?php if(($vo['status'] >= '3') and ($vo['status'] <= '5') ): ?><a  class="button_a_order"  href="<?php echo U('Shop/view_wuliu',array('order_id'=>$vo['order_id']));?>">查看物流</a><?php endif; ?>
