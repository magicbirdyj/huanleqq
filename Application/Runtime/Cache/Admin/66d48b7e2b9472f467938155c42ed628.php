...
<ul id="menu-ul">
  ...
  <li class="explode" key="02_guanggao" name="menu">
        ...
        <ul>
            <li class="menu-item"><a href="<?php echo U('Advert/advert');?>" target="main-frame">轮播广告</a></li>
        </ul>
  </li>
  <li class="explode" key="06_stats" name="menu">
    <a class="jibie_1">商品属性管理</a>
    <ul>
        <li class="menu-item"><a href="<?php echo U('Category/fenlei');?>" target="main-frame">商品分类管理</a></li>
        <li class="menu-item"><a href="<?php echo U('Category/manger');?>" target="main-frame">具体属性管理</a></li>
        </ul>
      </li>
  <li class="explode" key="07_content" name="menu">
        <a class="jibie_1">文章管理</a>
        <ul>
            <li class="menu-item"><a href="<?php echo U('News/index');?>" target="main-frame">文章列表</a></li>
            <li class="menu-item"><a href="<?php echo U('News/release_news');?>" target="main-frame">发布文章</a></li>
        </ul>
      </li>
  ...
  <li class="explode" key="users_manage" name="menu">
    ...
    <li class="explode" key="shops_manage" name="menu">
    <a class="jibie_1">店铺管理</a>
    <ul>
        <li class="menu-item"><a href="<?php echo U('Shopsmanage/index');?>" target="main-frame">店铺列表</a></li>
        <li class="menu-item"><a href="<?php echo U('Shopsmanage/add_shop');?>" target="main-frame">店铺注册</a></li>
    </ul>
      </li>
