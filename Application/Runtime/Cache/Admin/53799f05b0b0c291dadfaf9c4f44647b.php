...
<body>
    <div class="release">
        ...
        <form name="release_goods" method="post"  action="<?php echo U('Goodsmanage/release_check');?>" onsubmit="editor.sync()">
            ...
            <div class="tr">
                ...
                <input name="fanxian" type="text" class="text price_text"  />
                <span style="font-size: 14px;">元</span>
