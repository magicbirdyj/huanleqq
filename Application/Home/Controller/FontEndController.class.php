...
class FontEndController extends Controller {
    ...
    function __construct() {
        ...
        //不需要登陆的控制器或者方法
        $nologin_contorller = array('Login','Zhuce','Ajaxnologin','Crontab','Weixin','Index');//不需要登录的控制器
        $nologin=array('Charge/notifyweixin');//不需要登录的方法   //支付返回url
        ...
        if($_SERVER['HTTP_HOST']==='m.zsxjjd.com'||$_SERVER['HTTP_HOST']==='m.myhongbao.com'||$_SERVER['HTTP_HOST']==='xy.zsxjjd.com'){
