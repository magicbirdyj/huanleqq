    ...
    for(var i=0;i<10;i++){
        ...
        if(is_chou_ma.css('display')=='block'){//有筹码
            ...
            if(is_win===-1){//没中奖
                ...
                if(i===0||i===9){
                    balance=balance+arr_guess[i]*4*(1-choushui);
                }else if(i===1||i===2||i===7||i===8){
                    balance=balance+arr_guess[i]*2*(1-choushui);
                }else if(i===3||i===6){
                    balance=balance+arr_guess[i]*3*(1-choushui);
                }else if(i===4){
                    balance=balance+arr_guess[i]*60*(1-choushui);
                }else if(i===5){
                    balance=abalance+rr_guess[i]*30*(1-choushui);
                }
            }
        }
        if(i===9){
